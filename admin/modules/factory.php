        ...
        <div class="x_content">
            ...
            if (isset($_POST["addNew"])) {
                ...
                if (isset($_GET["id"]) && isset($_GET["edit"])) {
                    //Sửa theo id
                    $sql = "UPDATE factory SET fac_name='$facName', `status`='$status',date_create='$date_create' WHERE fac_id =" . $_GET["id"];
                    mysqli_query($conn, $sql) or ("Lỗi câu lệnh cập nhật ");
                    header("localhost:index.php?page=factory");
                } else {
            ...
            if (isset($_GET["id"]) && isset($_GET["edit"])) { //Lấy id
                $sql = "SELECT * FROM factory WHERE fac_id=" . $_GET["id"]; //Lấy dữ liệu qua id
                $result = mysqli_query($conn, $sql); //Hàm trả về giá trị
                $row = mysqli_fetch_row($result);
                // echo "<pre>";
                // print_r($row);
                $fac_name = $row[1]; //Gán dữ liệu
            ...
            if (isset($_GET["id"]) && isset($_GET["del"])) {
                $sql = "DELETE FROM factory WHERE fac_id=" . $_GET["id"];
            ...
            <form class="form-label-left input_mask" method="post">
                ...
                <div class="form-group row">
                    <label class="col-form-label col-md-3 col-sm-3 ">Tên thương hiệu</label>
                    <div class="col-md-9 col-sm-9 ">
                        <input type="text" class="form-control" value="<?php echo $fac_name; ?>" name="fac_name" id="fac_name" placeholder="Tên thương hiệu">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <div class="col-md-9 col-sm-9  offset-md-3">
                        ...
                        <a href="index.php?page=factory"><button type="button" class="btn btn-danger">Cancel</button></a>
