        ...
        <div class="x_content">
            ...
            if (isset($_POST["addNew"])) {
                ...
                if (isset($_GET["id"]) && isset($_GET["edit"])) {
                    //Sửa theo id
                    $sql = "UPDATE payment SET payment_name='$colName', `status`='$status',date_create='$date_create' WHERE payment_id =" . $_GET["id"];
                    mysqli_query($conn, $sql) or ("Lỗi câu lệnh cập nhật ");
                    header("localhost:index.php?page=payment");
                } else {
            ...
            if (isset($_GET["id"]) && isset($_GET["edit"])) { //Lấy id
                $sql = "SELECT * FROM payment WHERE payment_id=" . $_GET["id"]; //Lấy dữ liệu qua id
                $result = mysqli_query($conn, $sql); //Hàm trả về giá trị
                $row = mysqli_fetch_row($result);
                // echo "<pre>";
                // print_r($row);
                $payment_name = $row[1]; //Gán dữ liệu
            ...
            <form class="form-label-left input_mask" method="post">
                ...
                <div class="form-group row">
                    <label class="col-form-label col-md-3 col-sm-3 ">Tên phương thức</label>
                    <div class="col-md-9 col-sm-9 ">
                        <input type="text" class="form-control" value="<?php echo $payment_name; ?>" name="payment_name" id="payment_name" placeholder="Tên phương thức">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <div class="col-md-9 col-sm-9  offset-md-3">
                        ...
                        <a href="index.php?page=payment"><button type="button" class="btn btn-danger">Cancel</button></a>
    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <table class="table table-bordered">
                <!-- <button class="btn btn-btn-primary"> <a href="index.php?page=payment">
                ...
                ?>
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="index.php?page=payment&id=<?php echo $row["payment_id"] ?>&edit=1">
